...
cdef extern from "cvodes_cxx.hpp" namespace "cvodes_cxx":
    cdef void simple_predefined[U](
        ...
        vector[int]&, vector[double]&, double, double, double, long int, bool, int, int, int, double, unsigned) nogil except +
    ...
    cdef pair[vector[double], vector[double]] simple_adaptive[U](
        ...
        double, double, long int, bool, int, int, int, double, unsigned, bool) nogil except +
