...
env = {
    ...
    'SUNDIALS_LIBS': 'sundials_cvodes,sundials_nvecserial' + (
        ',sundials_sunlinsollapackdense,sundials_sunlinsollapackband' if (_sun3 and _lapack_ok) else (
            ',sundials_sunlinsoldense,sundials_sunlinsolband,sundials_sunmatrixdense,sundials_sunmatrixband,sundials_sunlinsolspgmr,sundials_sunlinsolspbcgs,sundials_sunlinsolsptfqmr' if (_sun3 and not _lapack_ok) else ''
        )
    ),
}
