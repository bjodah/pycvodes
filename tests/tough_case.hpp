...
AnyODE::Status OdeSys::rhs(double t,
    ...
    const double x6 = 20836612225.1252*m_p[0]*y[2]*exp(x1*(m_p[0]*(m_p[10] + m_p[12] + m_p[8]*x5) - m_p[11] - m_p[8]*x4 + x2));
...
AnyODE::Status OdeSys::dense_jac_cmaj(double t,
    ...
    const double x11 = x5*exp(x0*(m_p[0]*(m_p[10] + m_p[12] + m_p[8]*x8) - m_p[11] - m_p[8]*x7 + x1));
    const double x12 = x2*y[0];
